...
const isFigma2Page= location.pathname=== "/figma2";
  ...
  return (
    <div id="principal-container"  className={isCalculatorPage || isCodepenPage || isFigma1Page || isFigma2Page ? "calculator-background" : ""}>
      <Routes>
      ...
      {location.pathname === "/" && (
        <div id="box">
          ...
          <div className="social-icons">
            <a href="https://www.linkedin.com/in/isabela-albuquerque-38b16826b" target="_blank" rel="noopener noreferrer">
              <FaLinkedin className="icon linkedin" />
            </a>
            <a href="https://www.instagram.com/albq.bela/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="app-container">
        <div id="prin-container"> 
          <section id="about-section">
            ...
            <p id="about-text">
              Olá! Me chamo Isabela, prazer! Sou estudante de Sistemas de Informação, e sou apaixonada pela área de tecnologia - principalmente pelas áreas de programação e design de experiência do usuário.<br />
              Atualmente, ainda não trabalho em nenhuma dessas áreas, porém sigo em busca da minha primeira oportunidade! No meu dia a dia, utilizo as ferramentas essenciais para dar vida à um projeto web, como HTML, CSS, JavaScript e React (esse portfólio, por exemplo, foi feito com o framework React). Mas, meu trabalho não se limita à programação. Acredito que um bom design é fundamental para o sucesso de qualquer projeto. Por isso, me aprofundo em UX/UI Design, com princípios que buscam sempre proporcionar a melhor experiência ao usuário.
              Caso tenha interesse, abaixo na seção &ldquo;Trabalhos&rdquo; estão alguns dos meus projetos.
            </p>
          </section>
        ...
        <div id="roll">
          <div
            className={`icon-container ${selectedIcon === "about" ? "active" : ""}`}
          ...
          <div
            className={`icon-container ${selectedIcon === "work" ? "active" : ""}`}
          ...
          <div
            className={`icon-container ${selectedIcon === "contact" ? "active" : ""}`}
